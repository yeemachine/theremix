  ...
  >
    ...
    <div class="slide-content {currentSlide === 0 && $loaded ? 'current' : ''}">
      <container>
        <div class="graphic">
          <h2>
            Theremin<br />Controls<span
              style="font-size:9px;margin-left: 8px"
            >{$version ? $version : ''}<span></span></span>
          </h2>
          <div class="svg">
            <BasicControls
              color="rgb(var(--textColor1))"
              bgColor="rgb(var(--cardColor))"
            />
          </div>
        </div>
        <div class="description">
          <p>
            ...
            <span>controlled without physical touching it</span>. A thereminist
            plays by moving their hands in the space surrounding the 2 antennas.
            Movement towards the left antenna increases the
            <span>volume(amplitude)</span>
            while movement towards the right antenna increases the
            <span>pitch(frequency)</span>.
          </p>
          <p>
            THEREMIX's default controls translates these 2 movements into 1
            fluid cursor movement on desktop or touch on mobile/tablet.
          </p>
          <hr />
          <ol>
            <li>
              ...
              <p>
                Movement towards this antenna
                <span>(y-axis)</span>
                increases the
                <span>volume (amplitude)</span>
                of the current oscillator.
              </p>
            </li>
            <li>
              <h3>Pitch Antenna</h3>
              <p>
                Movement towards this antenna
                <span>(x-axis)</span>
                increases the frequency of the current oscillator, raising the
                <span>pitch</span>. You can modify the
                <span>octave</span>
                and
                <span>scale</span>
                of the pitch antenna under the Settings panel.
              </p>
            </li>
            <li>
              <h3>Master Volume</h3>
            ...
            <li>
              <h3>Oscillator</h3>
              <p>
                Choose from 18 different oscillator waveforms to change the
                timbre of the theremin. Includes
                <span>Sine</span>,
                <span>Triangle</span>,
                <span>Sawtooth</span>,
                <span>Square</span>,
                <span>Pulse</span>
                oscillators as well as many other alternates.
              </p>
              <p class="sub keyboard">
                <span class="keycap">O</span>
                to cycle between oscillators.
              </p>
              <p class="sub keyboard">
                <span class="keycap">O</span>
                + Arrow Keys to switch back and forth.
              </p>
            </li>
            <li>
              <h3>Glide</h3>
              <p>
                Glide is how the theremin tone operates traditionally,
                <span>sliding smoothly</span>
                between pitches. This is on by default. Turning this off will
                snap the tone to a
                <span>perfect note</span>.
              </p>
              <p class="sub keyboard">
                Hold/Release
                <span class="keycap">G</span>
                to toggle on/off glide.
              </p>
            </li>
            <li>
              <h3>Key/Scale</h3>
              <p>
                Modifying this setting changes the freqency range of the
                theremin as well as the tones played when Glide is off. Choose
                between
                <span>12 different tonic keys</span>
                and
                <span>18 different scales types</span>. Octave range is also
                adjustable under Settings.
              </p>
              <p class="sub keyboard">
                <span class="keycap">K</span>
                or
                <span class="keycap">S</span>
                to cycle between keys and scales.
              </p>
              <p class="sub keyboard">
                Hold
                <span class="keycap">K</span>
    ...
    <div class="slide-content {currentSlide === 1 && $loaded ? 'current' : ''}">
      <container>
        ...
        <div class="description">
          <p>
            By enabling your device's webcam, THEREMIX uses motion capture to
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                while the
                <span>left hand controls volume</span>. These controls are
                mapped to how a physical theremin would operate. Movement
                towards the right antenna increases the frequency while movement
                towards the left antenna increases the amplitude of the
                waveform.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                Mainly used when a user is viewing on mobile and needs one hand
                to hold the phone.
              </p>
            </li>
          </ul>
    ...
    <div class="slide-content {currentSlide === 2 && $loaded ? 'current' : ''}">
      <container>
        ...
        <div class="description">
          <p>
            A theremin can also be used as an
            <a
          ...
          <p>
            ...
            oscillators, changing variables such as
            <span>attack</span>,
            <span>sustain</span>,
            <span>decay</span>, and
          ...
          <p class="sub small keyboard">
            ...
            to toggle Midi on/off. Arrow Keys to switch between songs in queue.
          </p>
          <p class="sub small">
            List of the available MIDI demos. All credit for music,
            illustrations, and MIDI arranges go to their original creators.
          </p>
          <hr />
          <ol>
    ...
    <div class="slide-content {currentSlide === 3 && $loaded ? 'current' : ''}">
      <container>
        ...
        <div class="description">
          <p>
            THEREMIX is a cross-platform virtual theremin created in celebration
            of the
            <span>100th anniversary</span>
            of the theremin, invented by Léon Theremin in 1920.
          </p>
          ...
          <p>
            ...
            |
            <a
              href="https://github.com/yeemachine/theremix"
              target="blank"
            >Github</a>.
          </p>

          <p class="small sub">
            This app was made possible with the following platforms and
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                is a friendly platform for all your web project needs, from
                something as simple as a webpage to something more complex
                involving servers. All code written is hosted on Glitch's
                servers, making it easy to preview your work without needing to
                install packages or starting a web server. Remixing on Glitch
                also allows you to use projects from other creators as a
                starting template and explore their code. Feel free to
                <a href="https://glitch.com/~theremix" target="blank">Remix this
                  Project</a>
                on Glitch.
              </p>
            </li>
            <li>
              <h3>Pixijs</h3>
              <p>
                <a href="https://www.pixijs.com/" target="blank">Pixi.js</a>
                is a lightweight open source 2D WebGL renderer. This app is
                currently running on Pixi V4 with
                <a
                  href="https://github.com/pixijs/pixi-lights"
                  target="blank"
                >Pixi Lights</a>
                and
                <a
                  href="https://github.com/pixijs/pixi-particles"
                  target="blank"
                >Pixi Particles</a>
                plugins.
              </p>
            ...
            <li>
              <h3>Tonejs</h3>
              <p>
                <a href="https://tonejs.github.io/" target="blank">Tone.js</a>
                is a framework for creating interactive music in the browser. It
                provides advanced scheduling capabilities, synths and effects,
                and intuitive musical abstractions built on top of the Web Audio
                API.
              </p>
            </li>
            <li>
              ...
              <p>
                <a
                  ...
                  target="blank"
                >PoseNet</a>
                is a machine learning model which allows for real-time human
...
<style>
  ...
  section {
    ...
    --cardGradient: linear-gradient(
      0deg,
      rgb(var(--cardColor)) 0%,
      rgba(var(--cardColor), 0.920045518207283) 70%,
  ...
  section {
    ...
    transition: transform 0.6s cubic-bezier(0.49, 0.24, 0.51, 0.97), opacity 0s;
    opacity: 1;
  }
  ...
  section.hide {
    ...
    transition: transform 0.6s cubic-bezier(0.49, 0.24, 0.51, 0.97),
      opacity 0s 0.6s;
    pointer-events: none;
  }
  :global(.slides) {
  ...
  .description p.sub {
    color: rgba(var(--textColor2), 0.75);
  }
  .description p.small {
    margin: 0 0 16px 0;
    font-size: 14px;
  ...
  .keycap {
    ...
    background: rgba(var(--crimson), 0.2);
  ...
  :global(.left.disabled),
  :global(.right.disabled) {
    display: none;
  }
